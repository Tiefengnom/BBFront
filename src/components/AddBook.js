...
function AddBook({port}) {
    ...
    return (
        <div className=' mb-2 bg-white p-3 shadow-lg rounded transition-colors border-b-2 border-transparent lg:max-w-screen-3xl m-auto'>
            <button onClick={(e) => setStartScan(true)}  className='mt-6 mb-6 mr-4 inline-block px-6 py-2 border-2 border-white-500  font-medium text-xs leading-tight  rounded-full  hover:bg-orange-400  focus:outline-none focus:ring-0 transition duration-150 ease-in-out m-2'>Scan</button>
            <button onClick={(e) => setStartScan(false)} className=' bg-white bg-opacity-90 px-6 py-2 border-2 border-white-500  font-medium text-xs leading-tight  rounded-full  hover:bg-orange-400  focus:outline-none focus:ring-0 transition duration-150 ease-in-out cursor:pointer m-2'>Stop Scan</button>
            ...
            <form className='search-form' onSubmit={handleSubmit}>
                ...
                <button type='submit' className=' bg-white bg-opacity-90 px-6 py-2 border-2 border-white-500  font-medium text-xs leading-tight  rounded-full  hover:bg-orange-400  focus:outline-none focus:ring-0 transition duration-150 ease-in-out cursor:pointer m-2'>Search </button>
            </form>
                              ...
                              return (
                                  <div key={b.id}>
                                      ...
                                      <form
                                          ...
                                          />
                                          <button type='submit' className=' bg-white bg-opacity-60 px-6 py-2 border-2 border-white-500  font-medium text-xs leading-tight  rounded-full  hover:bg-orange-400  focus:outline-none focus:ring-0 transition duration-150 ease-in-out cursor:pointer m-2'>Add to my books</button>
                                      </form>
                                  </div>
                              );
                          })
